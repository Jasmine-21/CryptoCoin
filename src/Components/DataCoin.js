        ...
        return (
            <div className="container-fluid">
                ...
                <div className="row result text-center">
                    <div className="col-x1-2 col-lg2 col-md-2 result-table">
                        <table border="1px">
                            <tbody>
                                <tr>
                                    <td>
                                        <img src={this.props.dataobj.data.image.large} alt="Coin-Thumb" height="150px" width="150px" />
                                ...
                                <tr>
                                    <td>
                                        <ul className="list-unstyled">
                                            ...
                                            <li key="birthdate"> Date of Appearence -<br />{this.props.dataobj.data.genesis_date}</li>
                                            ...
                                            <li key="Community"> Community Score -<br />{this.props.dataobj.data.community_score}</li>
                                            <li key="liquidity"> Liquidity Score -<br />{this.props.dataobj.data.liquidity_score}</li>
                    ...
                    <div className="col-x1-10 col-lg-10 col-md-10 mt-5">
